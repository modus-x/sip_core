...
// Now we use the generic helper definitions above to define LIBSIP_CORE_PUBLIC and
// LIBSIP_CORE_LOCAL. LIBSIP_CORE_PUBLIC is used for the public API symbols. It is either DLL
