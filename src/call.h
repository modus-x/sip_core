...
public:
     ...
     */
    virtual void answer(const std::vector<libsip_core::MediaMap>& mediaList) = 0;
     ...
     */
    virtual void answerMediaChangeRequest(const std::vector<libsip_core::MediaMap>& mediaList,
                                          bool isRemote = false)
        = 0;
    /**
     * Hang up the call
     ...
     */
    virtual void carryingDTMFdigits(const std::string& dtmfEvents, double duration, unsigned int volume) = 0;
     ...
     * @return true on success
     */
    virtual bool requestMediaChange(const std::vector<libsip_core::MediaMap>& mediaList) = 0;

    /**
     * Retrieve current medias list
     * @return current medias
     */
    virtual std::vector<libsip_core::MediaMap> currentMediaList() const = 0;
